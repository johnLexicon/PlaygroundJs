...
function objectAccessors() {
    ...
    console.log(`Accessing with bracket notation: ${person["name"]} ${person["age"]}`);
    ...
    console.log(`Accessing with bracket and variable name: ${person[propertyName]}`)
}
...
function usingArrays() {
    ...
    for(let i = 0; i < listOfItems.length; i++) {
        console.log(`The value in index ${i} is ${listOfItems[i]} and its type is ${typeof listOfItems[i]}`);
    }
